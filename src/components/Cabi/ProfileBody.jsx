        ...
        <div className="exp_info_head">
          <div className="exp_info_head_left">
            ...
            <div className="profile_img">
              <img src={`${profile.image}`} style={{ width: "100px", height: "100px", marginBottom: "20px"}} />
              <input type="file" className="profile_input" onChange={(e)=> setSelectedFile(e.target.files[0])}
              />
            ...
            <div className="profile_img">
              ...
              <div className="file-input">
                <input type="file" name="file-input" onChange={(e)=> setSelectedFile(e.target.files[0])} id="file-input"
              ...
              <div className="prof_body_bonus_box_2_btn">
                <button onClick={()=> changePhoto()} className="profile_change_btn">Поменять</button>
              </div>
            </div>
            )}
