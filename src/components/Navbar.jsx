...
return (
<>
    <div className={`Navbar ${navbar ? 'active' : '' } ${location.pathname==='/Servic' && 'active' }
        ...
        <div className="navbar_container">
            <div className="navbar_raw">
                ...
                <div className="navbar_raw_menu">
                    <Link to='/Servic' className={`nav_a ${location.pathname==='/Servic' ? 'active' : '' }`}>Услуги
                    </Link>
                    <Link to='/Orders' className={`nav_a ${location.pathname==='/Orders' ? 'active' : '' }`}>Заказы
                    </Link>
                    <Link to='/Experts' className={`nav_a ${location.pathname==='/Experts' ? 'active' : '' }`}>Эксперты
                    </Link>
                    <Link to='/Shop' className={`nav_a ${location.pathname==='/Shop' ? 'active' : '' }`}>Магазин</Link>
                    <Link to='/Directory' className={`nav_a ${location.pathname==='/Directory' ? 'active' : '' }`}>
                    Справочник</Link>
                    <Link to='/Questions' className={`nav_a ${location.pathname==='/Questions' ? 'active' : '' }`}>
                    Вопросы</Link>
                    <Link to='/FAQ' className={`nav_a ${location.pathname==='/FAQ' ? 'active' : '' }`}>FAQ</Link>
                    <Link to='/Contact' className={`nav_a ${location.pathname==='/Contact' ? 'active' : '' }`}>Контакты
                    </Link>
                </div>
                <div className="navbar_raw_auth">
                    <Link to='/Registration' className={`nav_a ${location.pathname==='/Registration' ? 'active' : ''
                        }`}>Авторизация</Link>
