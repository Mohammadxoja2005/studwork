...
import { getMarket } from "../redux/slices/marketSlice";
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-9">
              <div className="order_in_box">
                <div className="orders_in_name">
                  Поправки в курсовой работе{" "}
                </div>
                  ...
                  <div className="orders_in_user_left">
                    <Link to="/ExpertInfo">
                      <img
                        ...
                        alt=""
                        className="orders_in_user_left_img"
                      />
                    </Link>
                    <div className="orders_in_user_left_text">
                      <Link
                        to="/ExpertInfo"
                        className="orders_in_user_left_text_a"
                      >
                        user462710{" "}
                      </Link>
                      <div className="orders_in_user_left_text_p">
                        Был(а) на сайте 43 минуты назад{" "}
                      </div>
                    </div>
                  </div>
                  <div className="orders_in_user_right">
                    <div className="orders_in_user_right_h">
                      Заказ открыт для предложений, исполнитель не выбран
                    </div>
                  ...
                  <div className="col-6">
                    <div className="orders_in_info">
                      ...
                      <div className="orders_in_info_text">
                        ...
                        <div className="orders_in_info_text_p">
                      ...
                      <div className="orders_in_info_text">
                        <div className="orders_in_info_text_h">
                          Антиплагиат{" "}
                        </div>
                  ...
                  <div className="col-6">
                    <div className="orders_in_info">
                      <div className="orders_in_info_text">
                        ...
                        <div className="orders_in_info_text_p_2">
                          <span>18 Окт в 14:00 </span>{" "}
                        </div>
                      </div>
                      <div className="orders_in_info_text">
                ...
                <div className="orders_in_main">
                  <div className="orders_in_main_name">
                    ...
                    <div className="col-6">
                      <div className="orders_in_main_box">
                        <div className="orders_in_main_text">
                          <div className="orders_in_main_h">
                            Разместите заказ{" "}
                          </div>
                          <img
                            src="/img/arrow_down.png"
                            alt=""
                            className="orders_in_main_img"
                          />
                          <div className="orders_in_main_h">
                    ...
                    <div className="col-6">
                      <div className="orders_in_main_box">
                        <div className="orders_in_main_box_text">
                          <div className="orders_in_main_box_h">
                            Гарантия на работу{" "}
                          </div>
                        ...
                        <div className="orders_in_main_box_text">
                          ...
                          <div className="orders_in_main_box_p">
                            Назначаете сами{" "}
                          </div>
                        </div>
                        <div className="orders_in_main_box_text">
                  ...
                  <div className="orders_in_main_btn">
                    <a href="">
